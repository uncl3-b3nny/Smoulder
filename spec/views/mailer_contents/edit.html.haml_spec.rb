...
RSpec.describe "mailer_contents/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit mailer_content form" do
    render

    assert_select "form[action=?][method=?]", mailer_content_path(@mailer_content), "post" do
