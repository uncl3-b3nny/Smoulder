module ApplicationHelper
  ...
  def love_bank_score
    ...
    love_bank = [gifts, words, acts_of_seacts_of_service, touch, qualityquality_time]
    # ADD HUMOR!
    ...
    def first_suggestion_category 
      if love_bank.max == gifts
        "Tangible Gifts"
      elsif love_bank.max == words
        "Words of affirmation"
      elsif love_bank.max == acts_of_service
        "Acts of Service"
      elsif love_bank.max == touch
        "Physical Touch"
      elsif love_bank.max == quality_time
        "Quality Time"  
      end
    end
